...
<html lang="en">
<head>
    <title>Code coverage report for lib/resources/packagings.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/resources/packagings.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/resources/</a> &#187; packagings.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var Packagings;
  ...
  request(
    {
      ...
      /* istanbul ignore if */
      <span class="skip-if-branch" title="if path not taken" >I</span>if (body.errors) {
<span class="cstat-skip" title="statement not covered" >        done(body.errors, body);</span>
      } else {
        done(e, body);
      }
    });
